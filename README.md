Bank Inquiry é uma aplicação simples que criei ao longo da primeira etapa na Carreira em Java pela Alura, desenvolvida para praticar lógica de programação, estruturas de controle e interação com o usuário via terminal.
